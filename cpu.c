    ...
    while (1) {
        ...
        switch (opcode) {  //MODE: Syntax
            ...
            case 0x0A: log("ASL A"); cyc += 2;
                ...
                break;
            case 0x06: log("ASL ");
                OP_ZP(value1, 0); ASL(MEM_AT(eaddr), value1); cyc += 5;
                break;
            case 0x16: log("ASL ");
                OP_ZP(value1, st->x); ASL(MEM_AT(eaddr), value1); cyc += 6;
                break;
            case 0x0E: log("ASL ");
                OP_ABS(value1, 0, 0); ASL(MEM_AT(eaddr), value1); cyc += 6;
                break;
            case 0x1E: log("ASL ");
                OP_ABS(value1, st->x, 0); ASL(MEM_AT(eaddr), value1); cyc += 7;
                break;
            ...
            //DEC
            case 0xC6: log("DEC ");
                OP_ZP(value1, 0); DEC(MEM_AT(eaddr), value1); cyc += 5;
                break;
            case 0xD6: log("DEC ");
                OP_ZP(value1, st->x); DEC(MEM_AT(eaddr), value1); cyc += 6;
                break;
            case 0xCE: log("DEC ");
                OP_ABS(value1, 0, 0); DEC(MEM_AT(eaddr), value1); cyc += 6;
                break;
            case 0xDE: log("DEC ");
                OP_ABS(value1, st->x, 0); DEC(MEM_AT(eaddr), value1); cyc += 7;
                break;
            ...
            //INC
            case 0xE6: log("INC ");
                OP_ZP(value1, 0); INC(MEM_AT(eaddr), value1); cyc += 5;
                break;
            case 0xF6: log("INC ");
                OP_ZP(value1, st->x); INC(MEM_AT(eaddr), value1); cyc += 6;
                break;
            case 0xEE: log("INC ");
                OP_ABS(value1, 0, 0); INC(MEM_AT(eaddr), value1); cyc += 6;
                break;
            case 0xFE: log("INC ");
                OP_ABS(value1, st->x, 0); INC(MEM_AT(eaddr), value1); cyc += 7;
                break;
            ...
            case 0x4A: log("LSR A");
                ...
                break;
            case 0x46: log("LSR ");
                OP_ZP(value1, 0); LSR(MEM_AT(eaddr), value1); cyc += 5;
                break;
            case 0x56: log("LSR ");
                OP_ZP(value1, st->x); LSR(MEM_AT(eaddr), value1); cyc += 6;
                break;
            case 0x4E: log("LSR ");
                OP_ABS(value1, 0, 0); LSR(MEM_AT(eaddr), value1); cyc += 6;
                break;
            case 0x5E: log("LSR ");
                OP_ABS(value1, st->x, 0); LSR(MEM_AT(eaddr), value1); cyc += 7;
                break;
            ...
            case 0x2A: log("ROL A");
                ...
                break;
            case 0x26: log("ROL ");
                OP_ZP(value1, 0); ROL(MEM_AT(eaddr), value1); cyc += 5;
                break;
            case 0x36: log("ROL ");
                OP_ZP(value1, st->x); ROL(MEM_AT(eaddr), value1); cyc += 6;
                break;
            case 0x2E: log("ROL ");
                OP_ABS(value1, 0, 0); ROL(MEM_AT(eaddr), value1); cyc += 6;
                break;
            case 0x3E: log("ROL ");
                OP_ABS(value1, st->x, 0); ROL(MEM_AT(eaddr), value1); cyc += 7;
                break;
            ...
            case 0x6A: log("ROR A"); cyc += 2;
                ...
                break;
            case 0x66: log("ROR ");
                OP_ZP(value1, 0); ROR(MEM_AT(eaddr), value1); cyc += 5;
                break;
            case 0x76: log("ROR ");
                OP_ZP(value1, st->x); ROR(MEM_AT(eaddr), value1); cyc += 6;
                break;
            case 0x6E: log("ROR ");
                OP_ABS(value1, 0, 0); ROR(MEM_AT(eaddr), value1); cyc += 6;
                break;
            case 0x7E: log("ROR ");
                OP_ABS(value1, st->x, 0); ROR(MEM_AT(eaddr), value1); cyc += 7;
                break;
